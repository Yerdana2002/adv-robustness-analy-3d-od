...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        extra_feat=extra_feat,
        roi_feats=14,        # 1/5 checkpoint: roi_mlp.0.weight=[512,75264]=14*14*3*128
        ...
        classaware_reg=True,  # 1/5 checkpoint: prediction_heads output per-class (x3 output dims)
        add_gt_pos_thresh=10.,  # 1/5 source config: 10.0 (full was 5.0)
...
load_from = './work_dirs/DeformFormer3D_Waymo15_L/epoch_36.pth'  # 1/5 split pretrain
resume = False

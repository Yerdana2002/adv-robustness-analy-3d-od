#!/usr/bin/env python3
# attack_focalformer_waymo_distributed.py
"""
Distributed launcher wrapper for attack_focalformer_waymo.py
Shards batches by batch_idx % world_size (same pattern as PillarNeSt DDP).
Run with: torchrun --standalone --nproc_per_node=4 attack_focalformer_waymo_distributed.py ...
"""
...
from attack_focalformer_waymo import run_waymo_adversarial_attack
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Distributed FocalFormer3D Waymo adversarial attack")

...
WORK_DIR=$PROJECT_ROOT/work_dirs/ff_grad_${TARGET_LAYER}_${MODE}_${SLURM_JOB_ID}
LOCAL_GRAD_DIR=$SLURM_TMPDIR/gradients
TAR_NAME=gradients_focalformer_l_${TARGET_LAYER}_channel.tar
...
echo "============================================================"
echo "FocalFormer3D-L gradient extraction (nuScenes val)"
echo "  mode       : $MODE"

...
dataset_type = 'NuScenesReducedDataset'
...
train_pipeline = [
    ...
    dict(type='ImageAug3D', 
        final_dim=(img_scale[1], img_scale[0]), resize_lim=[0.4, 0.6], bot_pct_lim=[0.0, 0.0], rot_lim=[-5.4, 5.4], rand_flip=True, is_train=True),
    ...
    dict(type='Collect3D', keys=['points', 'img', 'gt_bboxes_3d', 'gt_labels_3d'],
                meta_keys=('filename', 'ori_shape', 'img_shape', 'lidar2img',
                            ...
                            'transformation_3d_flow', 'img_aug_matrix'))
]
test_pipeline = [
    dict(
        type='LoadPointsFromFile',
...
#                     'pts_bbox_head.decoder.0': dict(lr_mult=0.1),
#                     'imgpts_neck.shared_conv_pts': dict(lr_mult=0.1),
#                     'pts_bbox_head.heatmap_head.': dict(lr_mult=0.1),
#                     'pts_bbox_head.prediction_heads.0': dict(lr_mult=0.1),
...
log_level = 'INFO'
work_dir = None
# load_img_from = 'pretrained/r50_fpn_voxel_0075.pth'
load_img_from = './work_dirs//DeformFormer3D_C_R50/epoch_20.pth'

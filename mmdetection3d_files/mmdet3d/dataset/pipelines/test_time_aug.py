...
import torch
from .LiDAR_corruptions import gaussian_noise,lidar_crosstalk_noise,density_dec_global,density_dec_local,cutout_local,uniform_noise,impulse_noise,scene_glare_noise,cutout_bbox,density_dec_bbox,gaussian_noise_bbox,scale_bbox,shear_bbox,moving_noise_bbox,uniform_noise_bbox,impulse_noise_bbox,rotation_bbox,spatial_alignment_noise,fulltrajectory_noise, temporal_alignment_noise
...
from .Camera_corruptions import ImageAddSnow,ImageAddFog,ImageAddRain,ImageAddGaussianNoise,ImageAddImpulseNoise,ImageAddUniformNoise
from .Camera_corruptions import ImageBBoxOperation, ImageBBoxOperationMono
from .Camera_corruptions import ImageMotionBlurFrontBack, ImageMotionBlurLeftRight

from .Camera_corruptions import ImageBBoxMotionBlurFrontBack, ImageBBoxMotionBlurLeftRight
from .Camera_corruptions import ImageBBoxMotionBlurFrontBackMono, ImageBBoxMotionBlurLeftRightMono
...
class CorruptionMethods(object):
    ...
    def __call__(self, results):
        ...
        if 'fog_sim' in self.corruption_severity_dict:
            import numpy as np
            img_bgr_255_np_uint8 = img_bgr_255_np_uint8 = [
                img.astype(np.uint8)

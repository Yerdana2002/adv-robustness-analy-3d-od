...
class CenterHead_f(BaseModule):
    """CenterHead for CenterPoint. Fixed to work for Kitti, changes taken from: https://github.com/open-mmlab/mmdetection3d/pull/924
    ...
    def __init__(self,
        ...
        super(CenterHead_f, self).__init__(init_cfg=init_cfg)

...
class CenterPoint_f(MVXTwoStageDetector):
    """
    This is a fix to Centerpoint to allow for Kitti compability. These changes were taken from: https://github.com/open-mmlab/mmdetection3d/pull/924
    ...
    def extract_pts_feat(self, pts, img_feats, img_metas):
        ...
        out_size_factor = cfg['pts'].get('out_size_factor', None) if cfg and 'pts' in cfg else None

        if out_size_factor == 4:

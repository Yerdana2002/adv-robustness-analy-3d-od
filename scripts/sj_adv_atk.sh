...
#python adversarial_attack_pipeline.py --preset-model centerpoint --debug
python /path/to/ECCV2026/adversarial_attack_pipeline.py --preset-model centerpoint --attack "iou_detachment" --num-samples 1 --debug
